    ...
    return (
        ...
        <div className="ml-64 pt-20 px-6 min-h-screen bg-[#121212]">
            <div className="flex flex-wrap gap-4 mb-6">
                ...
                <div className="bg-gray-800 text-white font-medium px-4 py-2 rounded w-[23%] flex items-center justify-center gap-2">
                ...
                <div className="bg-blue-800 text-white font-medium px-4 py-2 rounded w-[23%] flex items-center justify-center gap-2">
                    <FaSpinner className="text-lg animate-spin" />
                    <span>In Process</span>
                </div>

                <div className="bg-yellow-600 text-white font-medium px-4 py-2 rounded w-[23%] flex items-center justify-center gap-2">
            ...
            <div className="pt-5 pl-6 pb-8 min-h-screen bg-[#121212]">
                <div className="flex flex-wrap  justify-between">
                    ...
                    <div className="w-full md:w-[32%]">
                        ...
                        <div className="mt-4 h-[300px] bg-[#1f1f1f] rounded-xl p-4 text-white shadow-sm border border-[#333]">
